...
const struct CItem* _Nullable list_manager_create_item(const struct Toodle* _Nonnull manager, const char* _Nonnull name, const int64_t* _Nullable due_date, struct Label*_Nonnull* _Nonnull list);
const void list_manager_update_item(const struct Toodle* _Nonnull manager, const struct CItem* _Nonnull item, const char* _Nullable name, const int64_t* _Nullable due_date, const int64_t* _Nullable completion_date, struct label*_Nonnull* _Nullable list);
const struct CItemList*_Nonnull list_manager_get_all_items(const struct Toodle* _Nonnull manager);
